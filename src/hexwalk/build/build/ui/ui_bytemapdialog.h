...
public:
    ...
    void setupUi(QDialog *ByteMapDialog)
    {
        ...
        edtValue->setObjectName("edtValue");
        ...
        edtAddress->setObjectName("edtAddress");
