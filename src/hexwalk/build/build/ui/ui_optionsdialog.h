...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        gbColors->setObjectName("gbColors");
        ...
        pbHighlightingColor->setObjectName("pbHighlightingColor");

        gridLayout->addWidget(pbHighlightingColor, 0, 0, 1, 1);

        lbHighlightingColor = new QLabel(gbColors);
        lbHighlightingColor->setObjectName("lbHighlightingColor");
        ...
        pbSelectionColor->setObjectName("pbSelectionColor");

        gridLayout->addWidget(pbSelectionColor, 1, 0, 1, 1);

        lbSelectionColor = new QLabel(gbColors);
        lbSelectionColor->setObjectName("lbSelectionColor");
        ...
        pbAddressAreaColor->setObjectName("pbAddressAreaColor");

        gridLayout->addWidget(pbAddressAreaColor, 2, 0, 1, 1);

        lbAddressAreaColor = new QLabel(gbColors);
        lbAddressAreaColor->setObjectName("lbAddressAreaColor");
        ...
        pbAddressFontColor->setObjectName("pbAddressFontColor");

        gridLayout->addWidget(pbAddressFontColor, 3, 0, 1, 1);

        lbAddressFontColor = new QLabel(gbColors);
        lbAddressFontColor->setObjectName("lbAddressFontColor");
        ...
        pbAsciiAreaColor->setObjectName("pbAsciiAreaColor");

        gridLayout->addWidget(pbAsciiAreaColor, 4, 0, 1, 1);

        lbAsciiAreaColor = new QLabel(gbColors);
        lbAsciiAreaColor->setObjectName("lbAsciiAreaColor");
        ...
        pbAsciiFontColor->setObjectName("pbAsciiFontColor");

        gridLayout->addWidget(pbAsciiFontColor, 5, 0, 1, 1);

        lbAsciiFontColor = new QLabel(gbColors);
        lbAsciiFontColor->setObjectName("lbAsciiFontColor");
        ...
        pbHexFontColor->setObjectName("pbHexFontColor");

        gridLayout->addWidget(pbHexFontColor, 6, 0, 1, 1);

        lbHexFontColor = new QLabel(gbColors);
        lbHexFontColor->setObjectName("lbHexFontColor");
        ...
        pbWidgetFont->setObjectName("pbWidgetFont");

        gridLayout->addWidget(pbWidgetFont, 7, 0, 1, 1);

        leWidgetFont = new QLineEdit(gbColors);
        leWidgetFont->setObjectName("leWidgetFont");
