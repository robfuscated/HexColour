...
public:
    ...
    void setupUi(QDockWidget *DisasmWidget)
    {
        if (DisasmWidget->objectName().isEmpty())
            DisasmWidget->setObjectName(QString::fromUtf8("DisasmWidget"));
        ...
        comboEndian->addItem(QString());
        comboEndian->setObjectName(QString::fromUtf8("comboEndian"));
        comboEndian->setGeometry(QRect(80, 70, 111, 25));
        edtSelected = new QLineEdit(dockWidgetContents);
        edtSelected->setObjectName(QString::fromUtf8("edtSelected"));
        ...
        edtBaseAddr->setObjectName(QString::fromUtf8("edtBaseAddr"));
        edtBaseAddr->setGeometry(QRect(130, 2, 141, 25));
        lstDisasm = new QListWidget(dockWidgetContents);
        lstDisasm->setObjectName(QString::fromUtf8("lstDisasm"));
        ...
        btnDisasm->setObjectName(QString::fromUtf8("btnDisasm"));
        btnDisasm->setGeometry(QRect(200, 70, 71, 51));
        labelEndian = new QLabel(dockWidgetContents);
        labelEndian->setObjectName(QString::fromUtf8("labelEndian"));
