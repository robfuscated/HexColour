...
public:
    ...
    void setupUi(QMainWindow *HexWalkMain)
    {
        if (HexWalkMain->objectName().isEmpty())
            HexWalkMain->setObjectName(QString::fromUtf8("HexWalkMain"));
        ...
        tagsPane->setObjectName(QString::fromUtf8("tagsPane"));
        tagsPaneLayout = new QVBoxLayout(tagsPane);
        tagsPaneLayout->setObjectName(QString::fromUtf8("tagsPaneLayout"));
        tagsPaneLayout->setContentsMargins(0, 0, 0, 0);
        tagsGroupBox = new QGroupBox(tagsPane);
        tagsGroupBox->setObjectName(QString::fromUtf8("tagsGroupBox"));
        tagsGroupBoxLayout = new QVBoxLayout(tagsGroupBox);
        tagsGroupBoxLayout->setObjectName(QString::fromUtf8("tagsGroupBoxLayout"));
        tagsButtonLayout = new QHBoxLayout();
        tagsButtonLayout->setObjectName(QString::fromUtf8("tagsButtonLayout"));
        tagsLoadBtn = new QPushButton(tagsGroupBox);
        tagsLoadBtn->setObjectName(QString::fromUtf8("tagsLoadBtn"));

        tagsButtonLayout->addWidget(tagsLoadBtn);

        tagsSaveBtn = new QPushButton(tagsGroupBox);
        tagsSaveBtn->setObjectName(QString::fromUtf8("tagsSaveBtn"));

        tagsButtonLayout->addWidget(tagsSaveBtn);

        tagsResetBtn = new QPushButton(tagsGroupBox);
        tagsResetBtn->setObjectName(QString::fromUtf8("tagsResetBtn"));

        tagsButtonLayout->addWidget(tagsResetBtn);

        tagsHorizontalSpacer = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        tagsButtonLayout->addItem(tagsHorizontalSpacer);

        tagsDelBtn = new QPushButton(tagsGroupBox);
        tagsDelBtn->setObjectName(QString::fromUtf8("tagsDelBtn"));

        tagsButtonLayout->addWidget(tagsDelBtn);

        tagsAddBtn = new QPushButton(tagsGroupBox);
        tagsAddBtn->setObjectName(QString::fromUtf8("tagsAddBtn"));
        ...
        intlelbl->setObjectName(QString::fromUtf8("intlelbl"));
        intlelbl->setGeometry(QRect(140, 90, 51, 31));
        binlbl = new QLabel(groupBox);
        binlbl->setObjectName(QString::fromUtf8("binlbl"));
        ...
        decTextedit->setObjectName(QString::fromUtf8("decTextedit"));
        ...
        intleTextedit->setObjectName(QString::fromUtf8("intleTextedit"));
        ...
        binTextedit->setObjectName(QString::fromUtf8("binTextedit"));
        ...
        floatlbl_le->setObjectName(QString::fromUtf8("floatlbl_le"));
        floatlbl_le->setGeometry(QRect(560, 30, 61, 31));
        floatTextedit_le = new QLabel(groupBox);
        floatTextedit_le->setObjectName(QString::fromUtf8("floatTextedit_le"));
        ...
        asciilbl->setObjectName(QString::fromUtf8("asciilbl"));
        ...
        sellbl->setObjectName(QString::fromUtf8("sellbl"));
        sellbl->setGeometry(QRect(20, 30, 121, 31));
        selTextedit = new QLabel(groupBox);
        selTextedit->setObjectName(QString::fromUtf8("selTextedit"));
        ...
        signedcb->setObjectName(QString::fromUtf8("signedcb"));
        signedcb->setGeometry(QRect(20, 70, 88, 24));
        floatTextedit_be = new QLabel(groupBox);
        floatTextedit_be->setObjectName(QString::fromUtf8("floatTextedit_be"));
        ...
        floatlbl_be->setObjectName(QString::fromUtf8("floatlbl_be"));
